        ...
        <div class="card-header">
            <div class="d-flex justify-content-between align-content-end">
                ...
                <div class="col-3 dropdown pr-4 float-right">
                    <select wire:model="selectedCategory" class="form-control categories" name="categories" id="categories">
                ...
                <div class="col-2 ask-question">
                    <a href="{{ route('questions.create') }}" class="btn btn-outline-secondary float-right">{{ __('Ask Question') }}</a>
                </div>
            </div>
        </div>
        <div class="card-body">
